...
echo "127.0.0.1 localhost resentment" > /etc/hosts
...
bash -e build_scripts/chr-libstdcpp-pass-2.sh gcc-11.2.0.tar.xz
bash -e build_scripts/chr-gettext.sh gettext-0.21.tar.xz
bash -e build_scripts/chr-bison.sh bison-3.8.2.tar.xz
bash -e build_scripts/chr-perl.sh perl-5.34.0.tar.xz
bash -e build_scripts/chr-python.sh Python-3.10.2.tar.xz
